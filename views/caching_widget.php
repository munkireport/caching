<div class="col-lg-4 col-md-6">
	<div class="card" id="caching-widget">
		<div class="card-header" data-container="body" data-i18n="[title]caching.widget_tooltip">
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/caching/caching_widget', function( data ) {
		...
		var panel = $('#caching-widget div.card-body'),
